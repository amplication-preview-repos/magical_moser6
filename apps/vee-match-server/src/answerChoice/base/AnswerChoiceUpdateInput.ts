...
class AnswerChoiceUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => UserAnswerUpdateManyWithoutAnswerChoicesInput,
  })
  @ValidateNested()
  @Type(() => UserAnswerUpdateManyWithoutAnswerChoicesInput)
  @IsOptional()
  @Field(() => UserAnswerUpdateManyWithoutAnswerChoicesInput, {
    nullable: true,
  })
  userAnswers?: UserAnswerUpdateManyWithoutAnswerChoicesInput;
}

export { AnswerChoiceUpdateInput as AnswerChoiceUpdateInput };
