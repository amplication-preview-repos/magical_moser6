...
@InputType()
class UserAnswerCreateNestedManyWithoutAnswerChoicesInput {
...
export { UserAnswerCreateNestedManyWithoutAnswerChoicesInput as UserAnswerCreateNestedManyWithoutAnswerChoicesInput };
