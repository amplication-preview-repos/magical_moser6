...
@InputType()
class UserAnswerCreateNestedManyWithoutQuestionsInput {
...
export { UserAnswerCreateNestedManyWithoutQuestionsInput as UserAnswerCreateNestedManyWithoutQuestionsInput };
